...
The local workspace may contain tens or hundreds of GB of unpacked datasets plus
multi-GB archives. These files are ignored and should not be uploaded to a
normal Git remote.
